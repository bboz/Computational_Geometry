...
p=(0,0,0) #rastgele bir nokta koyup line a olan en yakın uzaklığı bulalalım   hat üzerindeki bir nokta  ,  hattı tanımlayan iki parametre
n=(1,1,1)  #hat üzerinde bir nokta
other_point=[1,1,100] #bulundugun nokta   bekleme noktası
n_p=point_on_line(n,p,other_point)  #neraest point , n_p değeri  hat üzerindeki bize en yakın nokta
